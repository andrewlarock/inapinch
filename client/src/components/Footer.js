    ...
    return (
      <div className={selectedType === 'Snow Removal' ? 'footer-blue' : 'footer'}>
          <div className="footer-container">
              ...
              <div className="footer-subheader-text">Proof of concept application connecting users to on-demand residential landscaping services and allowing them to offer skills and earn money locally.</div>
